...
const SOFTWARE_FACTORY_PACK: SectorPackDefinition = {
  ...
  fields: [
    ...
    { moduleKey: "proyectos", fieldKey: "estado", label: "Estado", kind: "status", required: true, placeholder: "activo / pausado / finalizado / expirado / por_renovar" },
    { moduleKey: "proyectos", fieldKey: "facturable", label: "Facturable", kind: "status", required: true, placeholder: "si / no — heredado del tipo, sobrescribible" },
    { moduleKey: "proyectos", fieldKey: "fechaInicio", label: "Fecha de inicio", kind: "text", placeholder: "YYYY-MM-DD" },
    { moduleKey: "proyectos", fieldKey: "fechaCaducidad", label: "Fecha de caducidad", kind: "text", placeholder: "YYYY-MM-DD — fin de vigencia del contrato" },
