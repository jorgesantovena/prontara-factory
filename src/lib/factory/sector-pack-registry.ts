...
const SOFTWARE_FACTORY_PACK: SectorPackDefinition = {
  ...
  modules: [
    ...
    // Facturación.pptx (Pedro) — Niveles y Contratos son los nuevos
    // portadores del método de facturación (sustituyen al Modo/Bolsa/
    // Unidad/Periodo del Cliente que pusimos en TEST-20 F).
    { moduleKey: "niveles", enabled: true, label: "Niveles", navigationLabel: "Niveles", emptyState: "Sin niveles definidos." },
    { moduleKey: "contratos", enabled: true, label: "Contratos", navigationLabel: "Contratos", emptyState: "Sin contratos activos." },
  ...
  fields: [
    ...
    // Facturación.pptx (Pedro) — El bloque Financiero del Cliente que
    // pusimos en TEST-20 F (Modo/Bolsa/Unidad/Margen/Periodo + Nivel +
    // Consumo/Facturado) MIGRA a la nueva tabla Contratos. Un cliente
    // puede tener varios contratos (Cuota nivel 2 trimestral + Bono
    ...
    // Facturación.pptx (Pedro) — Contrato heredado del proyecto.
    // Determina qué contrato del cliente consume estas horas.
  ...
  demoData: [
    ...
    { moduleKey: "clientes", records: [
      // Facturación.pptx (Pedro) — Cliente queda limpio de campos
      // financieros (vivían en TEST-20 F y ahora viven en Contrato).
      // Solo conserva tipoTarifa para lookup de Tarifas Especiales.
      { nombre: "Acme Labs", email: "laura@acme.com", telefono: "+34 600 111 101", estado: "activo", segmento: "Industria", tipoTarifa: "normal" },
      { nombre: "Nova Retail", email: "it@novaretail.com", telefono: "+34 600 111 102", estado: "activo", segmento: "Retail", tipoTarifa: "normal" },
      { nombre: "Binary Forge", email: "hola@binaryforge.es", telefono: "+34 600 111 103", estado: "seguimiento", segmento: "SaaS", tipoTarifa: "normal" },
      { nombre: "Talleres López", email: "admin@tallereslopez.com", telefono: "+34 600 111 104", estado: "activo", segmento: "Automoción", tipoTarifa: "normal" },
      { nombre: "Clínica Ardor", email: "direccion@clinicaardor.com", telefono: "+34 600 111 105", estado: "seguimiento", segmento: "Salud", tipoTarifa: "normal" },
      { nombre: "Polígono Demo SL", email: "admin@poligonodemo.es", telefono: "+34 600 111 106", estado: "activo", segmento: "Industrial", tipoTarifa: "especial" },
    ...
    { moduleKey: "proyectos", records: [
      ...
      { nombre: "Mant. Nivel 1 Delca", cliente: "Almacenes Delca SA", contrato: "CON-2026-010", codigoTipo: "MANT", responsable: "JJ", estado: "activo", facturable: "si", tipoFacturacion: "contra-bolsa", fechaInicio: "2026-01-01", fechaCaducidad: "2026-12-31", kilometros: "0", tarifaHoraOverride: "55", bolsaContratadaHoras: "10", notas: "Bolsa anual 10h. Cuando se supere, sobreconsumo a 55€/h." },
      { nombre: "Movilidad almacén (Kit digital)", cliente: "Almacenes Delca SA", contrato: "CON-2026-010", codigoTipo: "FASE_I", responsable: "MAR", estado: "activo", facturable: "si", tipoFacturacion: "fuera-bolsa", fechaInicio: "2026-01-01", fechaCaducidad: "2026-06-30", kilometros: "0", tarifaHoraOverride: "60", notas: "Proyecto Kit digital — fuera de bolsa, facturable por horas." },

      // ===== Acme Labs — iniciativa grande + servicios recurrentes =====
      { nombre: "ERP comercial Acme — Fase 2", cliente: "Acme Labs", codigoTipo: "FASE_I", responsable: "Laura", estado: "activo", facturable: "no", tipoFacturacion: "fija", fechaInicio: "2026-04-01", fechaCaducidad: "2026-09-30", kilometros: "240", tarifaHoraOverride: "60", notas: "Presupuesto cerrado 14.500€. Hitos por fase. Migración Navision pendiente." },
      { nombre: "Mantenimiento anual Acme", cliente: "Acme Labs", codigoTipo: "MANT", responsable: "Pablo", estado: "activo", facturable: "no", tipoFacturacion: "no-facturable", fechaInicio: "2026-01-01", fechaCaducidad: "2026-12-31", kilometros: "0", tarifaHoraOverride: "", notas: "Cubierto por cuota mensual. Bugs propios sin cargo." },
      { nombre: "Soporte usuarios Acme", cliente: "Acme Labs", contrato: "CON-2026-001", codigoTipo: "SOP", responsable: "Pablo", estado: "activo", facturable: "si", tipoFacturacion: "contra-bolsa", fechaInicio: "2026-01-01", fechaCaducidad: "2026-12-31", kilometros: "0", tarifaHoraOverride: "55", notas: "Bolsa 30h/año. Sobreconsumo a 60€/h." },
      { nombre: "Evolutivo sprint mensual Acme", cliente: "Acme Labs", contrato: "CON-2026-002", codigoTipo: "EVOLU", responsable: "Laura", estado: "por_renovar", facturable: "si", tipoFacturacion: "fuera-bolsa", fechaInicio: "2026-04-01", fechaCaducidad: "2026-05-31", kilometros: "60", tarifaHoraOverride: "60", notas: "Sprint mensual de mejoras. Renovar antes del 31-may." },

      // ===== Nova Retail — integración + servicios futuros =====
      { nombre: "Integración POS Nova", cliente: "Nova Retail", codigoTipo: "FASE_I", responsable: "Carlos", estado: "activo", facturable: "no", tipoFacturacion: "fija", fechaInicio: "2026-03-15", fechaCaducidad: "2026-07-15", kilometros: "180", tarifaHoraOverride: "60", notas: "Presupuesto 8.600€. 14 tiendas. Stripe + sync stock." },
      { nombre: "Soporte preventivo Nova POS", cliente: "Nova Retail", contrato: "CON-2026-003", codigoTipo: "SOP", responsable: "Carlos", estado: "activo", facturable: "si", tipoFacturacion: "contra-bolsa", fechaInicio: "2026-05-15", fechaCaducidad: "2026-11-15", kilometros: "0", tarifaHoraOverride: "55", notas: "Arranca con la entrega. Revisión mensual + parche trimestral." },

      // ===== Binary Forge — soporte IA con riesgo =====
      { nombre: "Plataforma soporte Binary", cliente: "Binary Forge", codigoTipo: "FASE_I", responsable: "Ana", estado: "activo", facturable: "no", tipoFacturacion: "fija", fechaInicio: "2026-02-01", fechaCaducidad: "2026-08-31", kilometros: "0", tarifaHoraOverride: "65", notas: "Memory leak no resuelto. Coste de tokens en riesgo. Estado ámbar." },
      { nombre: "Bolsa horas correctivo Binary", cliente: "Binary Forge", contrato: "CON-2026-004", codigoTipo: "BOLSA", responsable: "Ana", estado: "activo", facturable: "si", tipoFacturacion: "contra-bolsa", fechaInicio: "2026-01-01", fechaCaducidad: "2026-12-31", kilometros: "0", tarifaHoraOverride: "60", horasTotales: "30", notas: "30h prepagadas. Saldo se actualiza según partes imputados." },

      // ===== Talleres López — sustituyendo papel + Excel =====
      { nombre: "Gestión taller López", cliente: "Talleres López", codigoTipo: "FASE_I", responsable: "Miguel", estado: "finalizado", facturable: "no", tipoFacturacion: "fija", fechaInicio: "2025-10-01", fechaCaducidad: "2026-04-08", kilometros: "320", tarifaHoraOverride: "55", notas: "Entregada v2.1.0 el 08-abr-2026. Fase cerrada." },
      { nombre: "Mantenimiento adaptativo López — RGPD", cliente: "Talleres López", contrato: "CON-2026-006", codigoTipo: "NUEDES", responsable: "Miguel", estado: "finalizado", facturable: "si", tipoFacturacion: "fija", fechaInicio: "2026-02-01", fechaCaducidad: "2026-04-15", kilometros: "80", tarifaHoraOverride: "65", notas: "Adaptación RGPD. 16h consumidas de 16h contratadas. Cerrado." },
      { nombre: "Bolsa horas correctivo López", cliente: "Talleres López", contrato: "CON-2026-006", codigoTipo: "BOLSA", responsable: "Miguel", estado: "activo", facturable: "si", tipoFacturacion: "contra-bolsa", fechaInicio: "2026-01-01", fechaCaducidad: "2026-12-31", kilometros: "40", tarifaHoraOverride: "55", horasTotales: "24", notas: "24h prepagadas. Saldo se actualiza según partes imputados." },
      { nombre: "Formación usuarios López", cliente: "Talleres López", contrato: "CON-2026-006", codigoTipo: "FORM", responsable: "Miguel", estado: "finalizado", facturable: "si", tipoFacturacion: "fija", fechaInicio: "2026-04-10", fechaCaducidad: "2026-04-10", kilometros: "60", tarifaHoraOverride: "65", notas: "Sesión 2h con 4 mecánicos. Facturado." },

      // ===== Clínica Ardor — solo en piloto =====
      { nombre: "Piloto gestión de citas Clínica Ardor", cliente: "Clínica Ardor", codigoTipo: "SERPRE", responsable: "Laura", estado: "pausado", facturable: "no", tipoFacturacion: "fija", fechaInicio: "2026-04-01", fechaCaducidad: "2026-06-30", kilometros: "0", tarifaHoraOverride: "60", notas: "Presupuesto 6.500€ enviado. En espera de aprobación cliente." },
      ...
      { nombre: "Instalación inicial v1", cliente: "Polígono Demo SL", codigoTipo: "INST", responsable: "Pablo", estado: "activo", facturable: "no", tipoFacturacion: "fija", fechaInicio: "2024-01-15", fechaCaducidad: "2026-12-31", kilometros: "120", tarifaHoraOverride: "", notas: "Onboarding en cuota anual. Renovación automática." },
      { nombre: "Mantenimiento anual", cliente: "Polígono Demo SL", codigoTipo: "MANT", responsable: "Pablo", estado: "activo", facturable: "no", tipoFacturacion: "no-facturable", fechaInicio: "2024-01-15", fechaCaducidad: "2026-12-31", kilometros: "0", tarifaHoraOverride: "", notas: "En cuota mensual. Solo bugs propios." },
      { nombre: "Desarrollo nuevos módulos", cliente: "Polígono Demo SL", contrato: "CON-2026-008", codigoTipo: "NUEDES", responsable: "Laura", estado: "activo", facturable: "si", tipoFacturacion: "fuera-bolsa", fechaInicio: "2025-03-01", fechaCaducidad: "2026-12-31", kilometros: "180", tarifaHoraOverride: "", notas: "Funcionalidad nueva por petición. Por horas." },
      { nombre: "Soporte usuarios", cliente: "Polígono Demo SL", contrato: "CON-2026-008", codigoTipo: "SOP", responsable: "Carlos", estado: "activo", facturable: "si", tipoFacturacion: "contra-bolsa", fechaInicio: "2024-01-15", fechaCaducidad: "2026-12-31", kilometros: "60", tarifaHoraOverride: "", notas: "Tickets, dudas funcionales." },
    ...
    { moduleKey: "actividades", records: [
      ...
      { fecha: "2026-03-09", empleado: "Mario", cliente: "Almacenes Delca SA", proyecto: "Servicios Desarrollo nuevos módulos", actividad: "DEV", horaDesde: "08:30", horaHasta: "09:30", tiempoHoras: "01:00", lugar: "oficina", concepto: "Pedidos compra EDI. Ajustar formatos EDIVERSA - Proveedor EDE", tipoFacturacion: "contra-bolsa", facturable: "no", tarifaHora: "55", facturado: "no", facturaNumero: "", estado: "validada" },
      { fecha: "2026-01-09", empleado: "Julio", cliente: "Almacenes Delca SA", proyecto: "Servicios Desarrollo nuevos módulos", actividad: "DEV", horaDesde: "11:10", horaHasta: "15:00", tiempoHoras: "03:50", lugar: "oficina", concepto: "Cierre mensual. Cálculo de compras varios servidas", tipoFacturacion: "contra-bolsa", facturable: "no", tarifaHora: "55", facturado: "no", facturaNumero: "", estado: "validada" },
      { fecha: "2026-01-12", empleado: "Julio", cliente: "Almacenes Delca SA", proyecto: "Servicios Desarrollo nuevos módulos", actividad: "DEV", horaDesde: "15:00", horaHasta: "16:45", tiempoHoras: "01:45", lugar: "oficina", concepto: "Cierre mensual. Cálculo de compras varios servidas", tipoFacturacion: "contra-bolsa", facturable: "no", tarifaHora: "55", facturado: "no", facturaNumero: "", estado: "validada" },
      { fecha: "2026-02-23", empleado: "Julio", cliente: "Almacenes Delca SA", proyecto: "Servicios Desarrollo nuevos módulos", actividad: "DEV", horaDesde: "15:15", horaHasta: "17:15", tiempoHoras: "02:00", lugar: "teletrabajo", concepto: "Adaptación V7 para facturación electrónica con Indra (IndraFE)", tipoFacturacion: "contra-bolsa", facturable: "no", tarifaHora: "55", facturado: "no", facturaNumero: "", estado: "validada" },
      { fecha: "2026-03-06", empleado: "Mario", cliente: "Almacenes Delca SA", proyecto: "Servicios Desarrollo nuevos módulos", actividad: "DEV", horaDesde: "11:30", horaHasta: "15:30", tiempoHoras: "04:00", lugar: "oficina", concepto: "Pedidos compra EDI. Ajustar formatos EDIVERSA - Proveedor EDE", tipoFacturacion: "contra-bolsa", facturable: "no", tarifaHora: "55", facturado: "no", facturaNumero: "", estado: "validada" },
      { fecha: "2026-01-02", empleado: "Julio", cliente: "Almacenes Delca SA", proyecto: "Soporte a usuarios", actividad: "37", horaDesde: "10:30", horaHasta: "10:45", tiempoHoras: "00:15", lugar: "teletrabajo", concepto: "Con Angel Cuesta. Obtener listado de sumas y saldos", tipoFacturacion: "contra-bolsa", facturable: "no", tarifaHora: "55", facturado: "no", facturaNumero: "", estado: "validada" },
      { fecha: "2026-04-08", empleado: "Mario", cliente: "Almacenes Delca SA", proyecto: "Servicios Desarrollo nuevos módulos", actividad: "DEV", horaDesde: "12:00", horaHasta: "17:30", tiempoHoras: "05:30", lugar: "oficina", concepto: "Proceso inicial de limpieza de LOG's (fuera de bolsa)", tipoFacturacion: "fuera-bolsa", facturable: "si", tarifaHora: "55", facturado: "no", facturaNumero: "", estado: "validada" },
      { fecha: "2026-01-02", empleado: "Marcos", cliente: "Almacenes Delca SA", proyecto: "Movilidad almacén (Kit digital)", actividad: "DEV", horaDesde: "07:30", horaHasta: "14:30", tiempoHoras: "07:00", lugar: "casa_cliente", concepto: "Tablet picking", tipoFacturacion: "fuera-bolsa", facturable: "si", tarifaHora: "60", facturado: "no", facturaNumero: "", km: "42", estado: "validada" },
      { fecha: "2026-01-05", empleado: "Marcos", cliente: "Almacenes Delca SA", proyecto: "Movilidad almacén (Kit digital)", actividad: "DEV", horaDesde: "09:30", horaHasta: "15:30", tiempoHoras: "06:00", lugar: "casa_cliente", concepto: "Tablet Picking", tipoFacturacion: "fuera-bolsa", facturable: "si", tarifaHora: "60", facturado: "no", facturaNumero: "", km: "42", estado: "validada" },

      // ===== Acme Labs — Fase 2 (presupuesto cerrado, no facturable por horas) =====
      { fecha: "2026-04-21", empleado: "Pablo", cliente: "Acme Labs", proyecto: "ERP comercial Acme — Fase 2", actividad: "DEV", horaDesde: "09:00", horaHasta: "15:00", tiempoHoras: "06:00", lugar: "oficina", concepto: "Diseño endpoints + validaciones API REST de pedidos", tipoFacturacion: "fija", facturable: "no", tarifaHora: "60", facturado: "no", facturaNumero: "", estado: "validada" },
      { fecha: "2026-04-22", empleado: "Pablo", cliente: "Acme Labs", proyecto: "ERP comercial Acme — Fase 2", actividad: "DEV", horaDesde: "09:00", horaHasta: "15:00", tiempoHoras: "06:00", lugar: "oficina", concepto: "Implementación CRUD pedidos", tipoFacturacion: "fija", facturable: "no", tarifaHora: "60", facturado: "no", facturaNumero: "", estado: "validada" },
      { fecha: "2026-04-22", empleado: "Laura", cliente: "Acme Labs", proyecto: "ERP comercial Acme — Fase 2", actividad: "ANA", horaDesde: "10:00", horaHasta: "14:00", tiempoHoras: "04:00", lugar: "casa_cliente", concepto: "Cierre modelo + revisión con cliente (reunión presencial)", tipoFacturacion: "fija", facturable: "no", tarifaHora: "60", facturado: "no", facturaNumero: "", km: "60", estado: "validada" },

      // ===== Acme Labs — Soporte (facturable por horas, contra bolsa) =====
      { fecha: "2026-04-15", empleado: "Pablo", cliente: "Acme Labs", proyecto: "Soporte usuarios Acme", actividad: "37", horaDesde: "10:00", horaHasta: "11:30", tiempoHoras: "01:30", lugar: "teletrabajo", concepto: "Resolver dudas funcionales sobre módulo facturación", tipoFacturacion: "contra-bolsa", facturable: "si", tarifaHora: "55", facturado: "si", facturaNumero: "FAC-TECH-035", estado: "facturada" },
      { fecha: "2026-04-22", empleado: "Pablo", cliente: "Acme Labs", proyecto: "Soporte usuarios Acme", actividad: "37", horaDesde: "12:00", horaHasta: "14:00", tiempoHoras: "02:00", lugar: "teletrabajo", concepto: "Diagnóstico problema de impresión en cliente concreto", tipoFacturacion: "contra-bolsa", facturable: "si", tarifaHora: "55", facturado: "no", facturaNumero: "", estado: "validada" },

      // ===== Acme Labs — Evolutivo mensual =====
      { fecha: "2026-04-18", empleado: "Laura", cliente: "Acme Labs", proyecto: "Evolutivo sprint mensual Acme", actividad: "DEV", horaDesde: "09:00", horaHasta: "17:00", tiempoHoras: "08:00", lugar: "oficina", concepto: "Mejora pantalla pedidos según feedback usuario", tipoFacturacion: "fuera-bolsa", facturable: "si", tarifaHora: "60", facturado: "no", facturaNumero: "", estado: "validada" },
      { fecha: "2026-04-25", empleado: "Laura", cliente: "Acme Labs", proyecto: "Evolutivo sprint mensual Acme", actividad: "DEV", horaDesde: "10:00", horaHasta: "16:00", tiempoHoras: "06:00", lugar: "casa_cliente", concepto: "Filtros avanzados en listado clientes (validar UX in situ)", tipoFacturacion: "fuera-bolsa", facturable: "si", tarifaHora: "60", facturado: "no", facturaNumero: "", km: "30", estado: "validada" },

      // ===== Nova Retail — Integración POS (presupuesto cerrado) =====
      { fecha: "2026-04-23", empleado: "Carlos", cliente: "Nova Retail", proyecto: "Integración POS Nova", actividad: "DEV", horaDesde: "09:00", horaHasta: "14:00", tiempoHoras: "05:00", lugar: "oficina", concepto: "Implementación SDK Stripe + tests sandbox", tipoFacturacion: "fija", facturable: "no", tarifaHora: "60", facturado: "no", facturaNumero: "", estado: "validada" },
      ...
      { fecha: "2026-04-21", empleado: "Ana", cliente: "Binary Forge", proyecto: "Plataforma soporte Binary", actividad: "ANA", horaDesde: "09:00", horaHasta: "13:00", tiempoHoras: "04:00", lugar: "oficina", concepto: "Profile de memoria + análisis del worker (investigar causa raíz del cuelgue)", tipoFacturacion: "fija", facturable: "no", tarifaHora: "65", facturado: "no", facturaNumero: "", estado: "validada" },
      { fecha: "2026-04-22", empleado: "Ana", cliente: "Binary Forge", proyecto: "Plataforma soporte Binary", actividad: "ANA", horaDesde: "09:00", horaHasta: "13:00", tiempoHoras: "04:00", lugar: "oficina", concepto: "Reproducción local del leak con datos sintéticos", tipoFacturacion: "fija", facturable: "no", tarifaHora: "65", facturado: "no", facturaNumero: "", estado: "validada" },
      { fecha: "2026-04-25", empleado: "Ana", cliente: "Binary Forge", proyecto: "Plataforma soporte Binary", actividad: "DOC", horaDesde: "09:00", horaHasta: "14:00", tiempoHoras: "05:00", lugar: "oficina", concepto: "Redacción documento técnico arquitectura embeddings", tipoFacturacion: "fija", facturable: "no", tarifaHora: "65", facturado: "no", facturaNumero: "", estado: "validada" },

      // ===== Binary Forge — Bolsa horas correctivo =====
      { fecha: "2026-04-15", empleado: "Diego", cliente: "Binary Forge", proyecto: "Bolsa horas correctivo Binary", actividad: "37", horaDesde: "09:00", horaHasta: "12:00", tiempoHoras: "03:00", lugar: "teletrabajo", concepto: "Hotfix bug autenticación SSO (resta 3h de la bolsa de 30h)", tipoFacturacion: "contra-bolsa", facturable: "si", tarifaHora: "60", facturado: "si", facturaNumero: "FAC-TECH-036", estado: "facturada" },
      { fecha: "2026-04-23", empleado: "Diego", cliente: "Binary Forge", proyecto: "Bolsa horas correctivo Binary", actividad: "37", horaDesde: "09:00", horaHasta: "14:00", tiempoHoras: "05:00", lugar: "teletrabajo", concepto: "Investigación error 500 en exportación", tipoFacturacion: "contra-bolsa", facturable: "si", tarifaHora: "60", facturado: "no", facturaNumero: "", estado: "validada" },

      // ===== Talleres López — Mantenimiento RGPD (cerrado, ya facturado) =====
      { fecha: "2026-03-15", empleado: "Miguel", cliente: "Talleres López", proyecto: "Mantenimiento adaptativo López — RGPD", actividad: "ANA", horaDesde: "09:00", horaHasta: "13:00", tiempoHoras: "04:00", lugar: "casa_cliente", concepto: "Análisis requisitos RGPD nuevos", tipoFacturacion: "fija", facturable: "si", tarifaHora: "65", facturado: "si", facturaNumero: "FAC-TECH-033", km: "20", estado: "facturada" },
      { fecha: "2026-03-20", empleado: "Miguel", cliente: "Talleres López", proyecto: "Mantenimiento adaptativo López — RGPD", actividad: "DEV", horaDesde: "09:00", horaHasta: "17:00", tiempoHoras: "08:00", lugar: "oficina", concepto: "Implementación módulo consentimientos", tipoFacturacion: "fija", facturable: "si", tarifaHora: "65", facturado: "si", facturaNumero: "FAC-TECH-033", estado: "facturada" },
      ...
      { fecha: "2026-04-23", empleado: "Miguel", cliente: "Talleres López", proyecto: "Bolsa horas correctivo López", actividad: "37", horaDesde: "10:00", horaHasta: "12:00", tiempoHoras: "02:00", lugar: "casa_cliente", concepto: "Diagnóstico cálculo erróneo IVA (visita al taller)", tipoFacturacion: "contra-bolsa", facturable: "si", tarifaHora: "55", facturado: "no", facturaNumero: "", km: "20", estado: "validada" },

      // ===== Talleres López — Formación cerrada y facturada =====
      { fecha: "2026-04-10", empleado: "Miguel", cliente: "Talleres López", proyecto: "Formación usuarios López", actividad: "FORM", horaDesde: "10:00", horaHasta: "12:00", tiempoHoras: "02:00", lugar: "casa_cliente", concepto: "Sesión presencial 2h con mecánicos (bien recibido)", tipoFacturacion: "fija", facturable: "si", tarifaHora: "65", facturado: "si", facturaNumero: "FAC-TECH-034", km: "20", estado: "facturada" },
      { fecha: "2026-04-08", empleado: "Miguel", cliente: "Talleres López", proyecto: "Formación usuarios López", actividad: "DOC", horaDesde: "10:00", horaHasta: "12:00", tiempoHoras: "02:00", lugar: "oficina", concepto: "Preparación material formativo (interna no facturable)", tipoFacturacion: "no-facturable", facturable: "no", tarifaHora: "65", facturado: "no", facturaNumero: "", estado: "validada" },

      // ===== Imputación a proyecto MANT (no facturable, cubierto por mantenimiento) =====
      { fecha: "2026-04-26", empleado: "Pablo", cliente: "Acme Labs", proyecto: "Mantenimiento anual Acme", actividad: "37", horaDesde: "10:00", horaHasta: "11:30", tiempoHoras: "01:30", lugar: "teletrabajo", concepto: "Bug error 500 al borrar línea de pedido (bug propio cubierto por mantenimiento)", tipoFacturacion: "no-facturable", facturable: "no", tarifaHora: "55", facturado: "no", facturaNumero: "", estado: "validada" },
    ]},
...
/**
 * Vertical despacho de abogados (H5-VERT-02). Color #1e40af.
 */
const ABOGADOS_PACK: SectorPackDefinition = {
  key: "despacho-abogados",
  label: "Despacho de abogados",
  sector: "legal",
  businessType: "despacho-abogados",
  description: "ERP para despachos de abogados: clientes con expedientes, casos por materia, presupuestos honorarios, calendario de plazos procesales y facturación.",
  branding: { displayName: "Prontara Legal", shortName: "PL", accentColor: "#1e40af", logoHint: "legal, profesional, formal", tone: "sectorial" },
  labels: { clientes: "Clientes", crm: "Captación", proyectos: "Casos", presupuestos: "Honorarios", facturacion: "Facturas", documentos: "Expedientes", ajustes: "Ajustes", asistente: "Asistente" },
  renameMap: { proyecto: "caso", proyectos: "casos", documento: "expediente", documentos: "expedientes" },
  modules: [
    { moduleKey: "clientes", enabled: true, label: "Clientes", navigationLabel: "Clientes", emptyState: "Sin clientes." },
    { moduleKey: "crm", enabled: true, label: "Captación", navigationLabel: "Captación", emptyState: "Sin leads." },
    { moduleKey: "proyectos", enabled: true, label: "Casos", navigationLabel: "Casos", emptyState: "Sin casos abiertos." },
    { moduleKey: "presupuestos", enabled: true, label: "Honorarios", navigationLabel: "Honorarios", emptyState: "Sin presupuestos." },
  ...
  entities: [
    ...
    { key: "caso", label: "Caso", description: "Asunto legal en curso.", moduleKey: "proyectos", primaryFields: ["referencia", "cliente", "materia", "estado"], relatedTo: ["cliente", "expediente"] },
    { key: "expediente", label: "Expediente", description: "Documento de un caso.", moduleKey: "documentos", primaryFields: ["nombre", "caso", "tipo"], relatedTo: ["caso"] },
    { key: "honorarios", label: "Honorarios", description: "Presupuesto de honorarios.", moduleKey: "presupuestos", primaryFields: ["numero", "cliente", "importe"], relatedTo: ["cliente", "caso"] },
  ],
  fields: [
    // Clientes
    { moduleKey: "clientes", fieldKey: "nombre", label: "Nombre / Razón social", kind: "text", required: true },
    { moduleKey: "clientes", fieldKey: "tipoPersona", label: "Tipo persona", kind: "status", required: true, options: [{ value: "fisica", label: "Física" }, { value: "juridica", label: "Jurídica" }] },
    ...
    { moduleKey: "proyectos", fieldKey: "cliente", label: "Cliente", kind: "relation", required: true, relationModuleKey: "clientes" },
    { moduleKey: "proyectos", fieldKey: "materia", label: "Materia", kind: "status", required: true, options: [
      { value: "civil", label: "Civil" }, { value: "penal", label: "Penal" }, { value: "laboral", label: "Laboral" }, { value: "mercantil", label: "Mercantil" }, { value: "fiscal", label: "Fiscal" }, { value: "familia", label: "Familia" }, { value: "administrativo", label: "Administrativo" }, { value: "otro", label: "Otro" },
    ] },
    { moduleKey: "proyectos", fieldKey: "abogadoResponsable", label: "Abogado/a responsable", kind: "text" },
    { moduleKey: "proyectos", fieldKey: "juzgado", label: "Juzgado / Sede", kind: "text" },
    { moduleKey: "proyectos", fieldKey: "fechaApertura", label: "Fecha apertura", kind: "date" },
    { moduleKey: "proyectos", fieldKey: "proximoPlazo", label: "Próximo plazo", kind: "date" },
    { moduleKey: "proyectos", fieldKey: "estado", label: "Estado", kind: "status", required: true, options: [
      { value: "abierto", label: "Abierto" }, { value: "instruccion", label: "Instrucción" }, { value: "vista", label: "Vista" }, { value: "sentencia", label: "Sentencia" }, { value: "archivado", label: "Archivado" },
    ] },
    { moduleKey: "proyectos", fieldKey: "resumen", label: "Resumen", kind: "textarea" },
    // Honorarios
    { moduleKey: "presupuestos", fieldKey: "numero", label: "Nº", kind: "text", required: true },
    { moduleKey: "presupuestos", fieldKey: "cliente", label: "Cliente", kind: "relation", required: true, relationModuleKey: "clientes" },
    { moduleKey: "presupuestos", fieldKey: "concepto", label: "Concepto honorarios", kind: "textarea", required: true },
    { moduleKey: "presupuestos", fieldKey: "importe", label: "Importe", kind: "money", required: true },
    { moduleKey: "presupuestos", fieldKey: "estado", label: "Estado", kind: "status", required: true, options: [{ value: "borrador", label: "Borrador" }, { value: "enviado", label: "Enviado" }, { value: "aceptado", label: "Aceptado" }, { value: "rechazado", label: "Rechazado" }] },
    // Facturas
    { moduleKey: "facturacion", fieldKey: "numero", label: "Nº factura", kind: "text", required: true, placeholder: "FAC-LEG-2026-001" },
    { moduleKey: "facturacion", fieldKey: "cliente", label: "Cliente", kind: "text", required: true },
    { moduleKey: "facturacion", fieldKey: "concepto", label: "Concepto", kind: "text" },
    { moduleKey: "facturacion", fieldKey: "importe", label: "Importe", kind: "money", required: true },
    { moduleKey: "facturacion", fieldKey: "fechaEmision", label: "Fecha emisión", kind: "date" },
    ...
    { moduleKey: "crm", fieldKey: "telefono", label: "Teléfono", kind: "tel" },
    { moduleKey: "crm", fieldKey: "email", label: "Email", kind: "email" },
    { moduleKey: "crm", fieldKey: "asunto", label: "Asunto / consulta", kind: "textarea" },
    { moduleKey: "crm", fieldKey: "origen", label: "Origen", kind: "text" },
    { moduleKey: "crm", fieldKey: "estado", label: "Estado", kind: "status", required: true, options: [{ value: "lead", label: "Lead" }, { value: "consulta", label: "Primera consulta" }, { value: "cliente", label: "Cliente" }, { value: "perdido", label: "Perdido" }] },
    { moduleKey: "crm", fieldKey: "proximoPaso", label: "Próximo paso", kind: "text" },
    // Documentos / expedientes
    { moduleKey: "documentos", fieldKey: "nombre", label: "Documento", kind: "text", required: true },
    { moduleKey: "documentos", fieldKey: "caso", label: "Caso", kind: "relation", relationModuleKey: "proyectos" },
    { moduleKey: "documentos", fieldKey: "tipo", label: "Tipo", kind: "status", required: true, options: [
      { value: "demanda", label: "Demanda" }, { value: "contestacion", label: "Contestación" }, { value: "sentencia", label: "Sentencia" }, { value: "contrato", label: "Contrato" }, { value: "poder", label: "Poder" }, { value: "informe", label: "Informe" }, { value: "otro", label: "Otro" },
    ] },
    { moduleKey: "documentos", fieldKey: "fecha", label: "Fecha", kind: "date" },
    { moduleKey: "documentos", fieldKey: "estado", label: "Estado", kind: "status", required: true, options: [{ value: "borrador", label: "Borrador" }, { value: "presentado", label: "Presentado" }, { value: "archivado", label: "Archivado" }] },
  ],
  tableColumns: [
    { moduleKey: "clientes", fieldKey: "nombre", label: "Cliente", isPrimary: true },
    { moduleKey: "clientes", fieldKey: "nif", label: "NIF/CIF" },
    { moduleKey: "clientes", fieldKey: "telefono", label: "Teléfono" },
    { moduleKey: "clientes", fieldKey: "estado", label: "Estado" },
    { moduleKey: "proyectos", fieldKey: "referencia", label: "Ref.", isPrimary: true },
    { moduleKey: "proyectos", fieldKey: "cliente", label: "Cliente" },
    { moduleKey: "proyectos", fieldKey: "materia", label: "Materia" },
    { moduleKey: "proyectos", fieldKey: "abogadoResponsable", label: "Abogado/a" },
    { moduleKey: "proyectos", fieldKey: "proximoPlazo", label: "Próx. plazo" },
    { moduleKey: "proyectos", fieldKey: "estado", label: "Estado" },
    { moduleKey: "presupuestos", fieldKey: "numero", label: "Nº", isPrimary: true },
    { moduleKey: "presupuestos", fieldKey: "cliente", label: "Cliente" },
    { moduleKey: "presupuestos", fieldKey: "importe", label: "Importe" },
    ...
    { moduleKey: "crm", fieldKey: "estado", label: "Estado" },
    { moduleKey: "documentos", fieldKey: "nombre", label: "Documento", isPrimary: true },
    { moduleKey: "documentos", fieldKey: "caso", label: "Caso" },
    { moduleKey: "documentos", fieldKey: "tipo", label: "Tipo" },
    { moduleKey: "documentos", fieldKey: "fecha", label: "Fecha" },
    { moduleKey: "documentos", fieldKey: "estado", label: "Estado" },
  ],
  dashboardPriorities: [
    { key: "proyectos", label: "Casos abiertos", description: "Casos en curso.", order: 1 },
    { key: "proyectos", label: "Plazos próximos", description: "Casos con plazo procesal próximo.", order: 2 },
    { key: "facturas", label: "Facturas vencidas", description: "Cobros pendientes.", order: 3 },
    { key: "clientes", label: "Clientes activos", description: "Clientes con caso abierto.", order: 4 },
    { key: "actividad", label: "Actividad reciente", description: "Movimientos del despacho.", order: 5 },
  ],
  demoData: [
    { moduleKey: "clientes", records: [
      { nombre: "Construcciones Levante S.L.", tipoPersona: "juridica", nif: "B12345678", telefono: "+34 600 555 001", email: "info@conslevante.com", direccion: "Av. Reino 12, Valencia", estado: "activo" },
      { nombre: "María Hernández Ruiz", tipoPersona: "fisica", nif: "12345678X", telefono: "+34 600 555 002", email: "maria@email.com", direccion: "Madrid", estado: "activo" },
    ]},
    { moduleKey: "proyectos", records: [
      { referencia: "C-2026-001", cliente: "Construcciones Levante S.L.", materia: "mercantil", abogadoResponsable: "Sr. García", juzgado: "Mercantil 4 Valencia", fechaApertura: "2026-02-01", proximoPlazo: "2026-05-20", estado: "instruccion", resumen: "Reclamación de cantidad por incumplimiento contractual." },
      { referencia: "C-2026-002", cliente: "María Hernández Ruiz", materia: "familia", abogadoResponsable: "Sra. López", juzgado: "Familia 3 Madrid", fechaApertura: "2026-03-10", proximoPlazo: "2026-06-05", estado: "abierto", resumen: "Modificación de medidas." },
    ]},
    { moduleKey: "presupuestos", records: [
      { numero: "HON-2026-001", cliente: "Construcciones Levante S.L.", concepto: "Reclamación cantidad — minuta + suplidos", importe: "4500 EUR", estado: "aceptado" },
    ]},
    { moduleKey: "facturacion", records: [
      { numero: "FAC-LEG-2026-001", cliente: "Construcciones Levante S.L.", concepto: "Provisión de fondos C-2026-001", importe: "2000 EUR", fechaEmision: "2026-02-15", estado: "cobrada" },
    ]},
    { moduleKey: "crm", records: [
      { nombre: "Pedro Sanz", telefono: "+34 600 555 003", email: "pedro@email.com", asunto: "Despido improcedente — consulta inicial", origen: "Recomendación", estado: "lead", proximoPaso: "Agendar primera consulta" },
    ]},
    { moduleKey: "documentos", records: [
      { nombre: "Demanda mercantil C-2026-001", caso: "C-2026-001", tipo: "demanda", fecha: "2026-02-05", estado: "presentado" },
      { nombre: "Poder general procuradores", caso: "C-2026-001", tipo: "poder", fecha: "2026-02-01", estado: "archivado" },
    ]},
  ],
  landing: {
    headline: "El despacho, organizado por casos.",
    subheadline: "ERP para despachos de abogados: clientes con expedientes, casos por materia con plazos procesales, honorarios firmables y facturación con IVA.",
    bullets: ["Clientes persona física o jurídica con CIF/NIF", "Casos con materia y plazo procesal próximo destacado", "Expedientes asociados a cada caso", "Presupuestos de honorarios y facturas con IVA"],
    cta: "Activa tu despacho online",
  },
  assistantCopy: {
    welcome: "Te ayudo con casos abiertos, plazos próximos, honorarios y facturas del despacho.",
    suggestion: "¿Qué casos tienen plazo en los próximos 7 días?",
  },
};

/**
 * Vertical hostelería / restaurante (H5-VERT-03). Color #d97706.
 */
const HOSTELERIA_PACK: SectorPackDefinition = {
  key: "hosteleria",
  label: "Hostelería / Restaurante",
  sector: "hosteleria",
  businessType: "hosteleria",
  description: "ERP para restaurantes, cafeterías y bares: mesas con reserva, comandas, carta digital, proveedores, control de costes y facturación.",
  branding: { displayName: "Prontara Hostelería", shortName: "PH", accentColor: "#d97706", logoHint: "hostelería, calidez, comida", tone: "sectorial" },
  labels: { clientes: "Clientes habituales", crm: "Captación", proyectos: "Eventos", presupuestos: "Presupuestos eventos", facturacion: "Facturas", documentos: "Documentos", ajustes: "Ajustes", asistente: "Asistente" },
  renameMap: { proyecto: "evento", proyectos: "eventos" },
  modules: [
    { moduleKey: "clientes", enabled: true, label: "Clientes habituales", navigationLabel: "Clientes", emptyState: "Sin clientes habituales registrados." },
    { moduleKey: "crm", enabled: true, label: "Captación eventos", navigationLabel: "Captación", emptyState: "Sin solicitudes." },
    { moduleKey: "proyectos", enabled: true, label: "Eventos", navigationLabel: "Eventos", emptyState: "Sin eventos planificados." },
    { moduleKey: "presupuestos", enabled: true, label: "Presupuestos eventos", navigationLabel: "Presupuestos", emptyState: "Sin presupuestos." },
    { moduleKey: "facturacion", enabled: true, label: "Facturas", navigationLabel: "Facturas", emptyState: "Sin facturas." },
  ...
  entities: [
    ...
    { key: "evento", label: "Evento / Reserva grande", description: "Bodas, comuniones, comidas de empresa.", moduleKey: "proyectos", primaryFields: ["fecha", "tipo", "comensales"], relatedTo: ["cliente", "factura"] },
  ],
  fields: [
    { moduleKey: "clientes", fieldKey: "nombre", label: "Cliente", kind: "text", required: true },
    { moduleKey: "clientes", fieldKey: "telefono", label: "Teléfono", kind: "tel" },
    { moduleKey: "clientes", fieldKey: "email", label: "Email", kind: "email" },
    ...
    { moduleKey: "proyectos", fieldKey: "cliente", label: "Cliente", kind: "relation", required: true, relationModuleKey: "clientes" },
    { moduleKey: "proyectos", fieldKey: "fecha", label: "Fecha", kind: "date", required: true },
    { moduleKey: "proyectos", fieldKey: "horaInicio", label: "Hora", kind: "text", placeholder: "14:00" },
    { moduleKey: "proyectos", fieldKey: "comensales", label: "Comensales", kind: "number", required: true },
    { moduleKey: "proyectos", fieldKey: "menu", label: "Menú", kind: "textarea" },
    { moduleKey: "proyectos", fieldKey: "estado", label: "Estado", kind: "status", required: true, options: [{ value: "reservado", label: "Reservado" }, { value: "confirmado", label: "Confirmado" }, { value: "celebrado", label: "Celebrado" }, { value: "cancelado", label: "Cancelado" }] },
    { moduleKey: "presupuestos", fieldKey: "numero", label: "Nº", kind: "text", required: true },
    { moduleKey: "presupuestos", fieldKey: "cliente", label: "Cliente", kind: "relation", required: true, relationModuleKey: "clientes" },
    { moduleKey: "presupuestos", fieldKey: "concepto", label: "Concepto", kind: "textarea", required: true },
    { moduleKey: "presupuestos", fieldKey: "importe", label: "Importe", kind: "money", required: true },
    { moduleKey: "presupuestos", fieldKey: "estado", label: "Estado", kind: "status", required: true, options: [{ value: "borrador", label: "Borrador" }, { value: "enviado", label: "Enviado" }, { value: "aceptado", label: "Aceptado" }, { value: "rechazado", label: "Rechazado" }] },
    { moduleKey: "facturacion", fieldKey: "numero", label: "Nº factura", kind: "text", required: true, placeholder: "FAC-HOS-2026-001" },
    { moduleKey: "facturacion", fieldKey: "cliente", label: "Cliente", kind: "text", required: true },
    { moduleKey: "facturacion", fieldKey: "concepto", label: "Concepto", kind: "text" },
    { moduleKey: "facturacion", fieldKey: "importe", label: "Importe", kind: "money", required: true },
    { moduleKey: "facturacion", fieldKey: "fechaEmision", label: "Fecha emisión", kind: "date" },
    ...
    { moduleKey: "crm", fieldKey: "telefono", label: "Teléfono", kind: "tel" },
    { moduleKey: "crm", fieldKey: "email", label: "Email", kind: "email" },
    { moduleKey: "crm", fieldKey: "tipoEvento", label: "Tipo evento", kind: "text" },
    { moduleKey: "crm", fieldKey: "fecha", label: "Fecha solicitada", kind: "date" },
    { moduleKey: "crm", fieldKey: "comensales", label: "Comensales", kind: "number" },
    { moduleKey: "crm", fieldKey: "estado", label: "Estado", kind: "status", required: true, options: [{ value: "lead", label: "Lead" }, { value: "presupuestado", label: "Presupuestado" }, { value: "confirmado", label: "Confirmado" }, { value: "perdido", label: "Perdido" }] },
    { moduleKey: "documentos", fieldKey: "nombre", label: "Documento", kind: "text", required: true },
    { moduleKey: "documentos", fieldKey: "tipo", label: "Tipo", kind: "status", required: true, options: [{ value: "menu", label: "Menú" }, { value: "carta", label: "Carta" }, { value: "contrato", label: "Contrato evento" }, { value: "otro", label: "Otro" }] },
    { moduleKey: "documentos", fieldKey: "fecha", label: "Fecha", kind: "date" },
    { moduleKey: "documentos", fieldKey: "estado", label: "Estado", kind: "status", required: true, options: [{ value: "vigente", label: "Vigente" }, { value: "archivado", label: "Archivado" }] },
  ],
  tableColumns: [
    { moduleKey: "clientes", fieldKey: "nombre", label: "Cliente", isPrimary: true },
    { moduleKey: "clientes", fieldKey: "telefono", label: "Teléfono" },
    { moduleKey: "clientes", fieldKey: "estado", label: "Estado" },
    { moduleKey: "proyectos", fieldKey: "fecha", label: "Fecha", isPrimary: true },
    { moduleKey: "proyectos", fieldKey: "tipo", label: "Tipo" },
    { moduleKey: "proyectos", fieldKey: "cliente", label: "Cliente" },
    { moduleKey: "proyectos", fieldKey: "comensales", label: "Comensales" },
    { moduleKey: "proyectos", fieldKey: "estado", label: "Estado" },
    { moduleKey: "presupuestos", fieldKey: "numero", label: "Nº", isPrimary: true },
    { moduleKey: "presupuestos", fieldKey: "cliente", label: "Cliente" },
    { moduleKey: "presupuestos", fieldKey: "importe", label: "Importe" },
  ...
  dashboardPriorities: [
    { key: "proyectos", label: "Eventos próximos", description: "Eventos esta semana.", order: 1 },
    { key: "crm", label: "Solicitudes nuevas", description: "Captación pendiente.", order: 2 },
    { key: "facturas", label: "Facturas vencidas", description: "Cobros pendientes.", order: 3 },
    { key: "clientes", label: "Clientes habituales", description: "Histórico activo.", order: 4 },
    { key: "actividad", label: "Actividad reciente", description: "Últimos movimientos.", order: 5 },
  ],
  demoData: [
    { moduleKey: "clientes", records: [{ nombre: "Familia Pérez Ruiz", telefono: "+34 600 666 001", email: "perez@email.com", preferencias: "Sin gluten en niños", estado: "activo" }] },
    { moduleKey: "proyectos", records: [{ nombre: "Boda Pérez/Ruiz", tipo: "boda", cliente: "Familia Pérez Ruiz", fecha: "2026-06-21", horaInicio: "14:00", comensales: "120", menu: "Menú degustación 5 platos + barra libre", estado: "confirmado" }] },
    { moduleKey: "presupuestos", records: [{ numero: "PRE-HOS-2026-001", cliente: "Familia Pérez Ruiz", concepto: "Boda 120 pax — menú degustación + barra libre", importe: "8400 EUR", estado: "aceptado" }] },
    { moduleKey: "facturacion", records: [{ numero: "FAC-HOS-2026-001", cliente: "Familia Pérez Ruiz", concepto: "Señal evento boda 21/06", importe: "2000 EUR", fechaEmision: "2026-04-10", estado: "cobrada" }] },
    { moduleKey: "crm", records: [{ nombre: "Empresa Logística X", telefono: "+34 600 666 002", email: "rrhh@logx.com", tipoEvento: "Comida fin de año", fecha: "2026-12-15", comensales: "60", estado: "lead" }] },
    { moduleKey: "documentos", records: [{ nombre: "Carta primavera 2026", tipo: "carta", fecha: "2026-04-01", estado: "vigente" }] },
  ],
  landing: {
    headline: "El restaurante, sin perder una reserva.",
    subheadline: "ERP para hostelería: clientes habituales con preferencias, eventos con comensales y menú, presupuestos firmables, facturación con IVA.",
    bullets: ["Clientes habituales con alergias y preferencias", "Eventos con menú detallado y número de comensales", "Captación de eventos desde el primer contacto", "Caja diaria con métodos de pago"],
    cta: "Activa tu restaurante online",
  },
  assistantCopy: {
    welcome: "Te ayudo con eventos próximos, presupuestos abiertos, clientes habituales y facturación del local.",
    suggestion: "¿Qué eventos tengo este fin de semana?",
  },
};

/**
 * Vertical inmobiliaria (H5-VERT-04). Color #0891b2.
 */
const INMOBILIARIA_PACK: SectorPackDefinition = {
  key: "inmobiliaria",
  label: "Inmobiliaria",
  sector: "inmobiliaria",
  businessType: "inmobiliaria",
  description: "ERP para inmobiliarias: cartera de inmuebles, propietarios, captación de compradores e inquilinos, visitas, ofertas y facturación de comisiones.",
  branding: { displayName: "Prontara Inmobiliaria", shortName: "PI", accentColor: "#0891b2", logoHint: "inmobiliaria, espacios, arquitectura", tone: "sectorial" },
  labels: { clientes: "Propietarios e interesados", crm: "Captación interesados", proyectos: "Inmuebles", presupuestos: "Ofertas", facturacion: "Facturas comisión", documentos: "Documentación", ajustes: "Ajustes", asistente: "Asistente" },
  renameMap: { proyecto: "inmueble", proyectos: "inmuebles" },
  modules: [
    { moduleKey: "clientes", enabled: true, label: "Propietarios e interesados", navigationLabel: "Personas", emptyState: "Sin contactos." },
    { moduleKey: "crm", enabled: true, label: "Captación interesados", navigationLabel: "Captación", emptyState: "Sin leads." },
    { moduleKey: "proyectos", enabled: true, label: "Inmuebles", navigationLabel: "Inmuebles", emptyState: "Sin inmuebles en cartera." },
    { moduleKey: "presupuestos", enabled: true, label: "Ofertas", navigationLabel: "Ofertas", emptyState: "Sin ofertas activas." },
  ...
  entities: [
    ...
    { key: "inmueble", label: "Inmueble", description: "Propiedad en cartera.", moduleKey: "proyectos", primaryFields: ["referencia", "tipo", "ciudad", "precio"], relatedTo: ["persona", "oferta", "documento"] },
  ],
  fields: [
    { moduleKey: "clientes", fieldKey: "nombre", label: "Nombre", kind: "text", required: true },
    { moduleKey: "clientes", fieldKey: "tipo", label: "Tipo", kind: "status", required: true, options: [{ value: "propietario", label: "Propietario" }, { value: "interesado", label: "Interesado compra" }, { value: "inquilino", label: "Inquilino interesado" }, { value: "otro", label: "Otro" }] },
    { moduleKey: "clientes", fieldKey: "telefono", label: "Teléfono", kind: "tel" },
    { moduleKey: "clientes", fieldKey: "email", label: "Email", kind: "email" },
    ...
    { moduleKey: "proyectos", fieldKey: "operacion", label: "Operación", kind: "status", required: true, options: [{ value: "venta", label: "Venta" }, { value: "alquiler", label: "Alquiler" }, { value: "alquiler-vacacional", label: "Alquiler vacacional" }] },
    { moduleKey: "proyectos", fieldKey: "direccion", label: "Dirección", kind: "text", required: true },
    { moduleKey: "proyectos", fieldKey: "ciudad", label: "Ciudad", kind: "text" },
    { moduleKey: "proyectos", fieldKey: "metros", label: "m²", kind: "number" },
    { moduleKey: "proyectos", fieldKey: "habitaciones", label: "Habitaciones", kind: "number" },
    { moduleKey: "proyectos", fieldKey: "precio", label: "Precio", kind: "money", required: true },
    { moduleKey: "proyectos", fieldKey: "propietario", label: "Propietario", kind: "relation", relationModuleKey: "clientes" },
    { moduleKey: "proyectos", fieldKey: "estado", label: "Estado", kind: "status", required: true, options: [{ value: "captado", label: "Captado" }, { value: "publicado", label: "Publicado" }, { value: "reservado", label: "Reservado" }, { value: "vendido", label: "Vendido / Alquilado" }, { value: "retirado", label: "Retirado" }] },
    { moduleKey: "proyectos", fieldKey: "descripcion", label: "Descripción", kind: "textarea" },
    { moduleKey: "presupuestos", fieldKey: "numero", label: "Nº oferta", kind: "text", required: true },
    { moduleKey: "presupuestos", fieldKey: "cliente", label: "Comprador", kind: "relation", required: true, relationModuleKey: "clientes" },
    { moduleKey: "presupuestos", fieldKey: "inmueble", label: "Inmueble", kind: "relation", relationModuleKey: "proyectos" },
    { moduleKey: "presupuestos", fieldKey: "concepto", label: "Concepto", kind: "textarea" },
    { moduleKey: "presupuestos", fieldKey: "importe", label: "Importe oferta", kind: "money", required: true },
    { moduleKey: "presupuestos", fieldKey: "estado", label: "Estado", kind: "status", required: true, options: [{ value: "presentada", label: "Presentada" }, { value: "negociacion", label: "En negociación" }, { value: "aceptada", label: "Aceptada" }, { value: "rechazada", label: "Rechazada" }] },
    { moduleKey: "facturacion", fieldKey: "numero", label: "Nº factura", kind: "text", required: true, placeholder: "FAC-INM-2026-001" },
    { moduleKey: "facturacion", fieldKey: "cliente", label: "Cliente", kind: "text", required: true },
    ...
    { moduleKey: "crm", fieldKey: "telefono", label: "Teléfono", kind: "tel" },
    { moduleKey: "crm", fieldKey: "email", label: "Email", kind: "email" },
    { moduleKey: "crm", fieldKey: "buscando", label: "Busca", kind: "textarea" },
    { moduleKey: "crm", fieldKey: "presupuesto", label: "Presupuesto", kind: "money" },
    { moduleKey: "crm", fieldKey: "estado", label: "Estado", kind: "status", required: true, options: [{ value: "lead", label: "Lead" }, { value: "visitas", label: "Visitando" }, { value: "ofertado", label: "Con oferta" }, { value: "cerrado", label: "Cliente" }, { value: "perdido", label: "Perdido" }] },
    { moduleKey: "documentos", fieldKey: "nombre", label: "Documento", kind: "text", required: true },
    { moduleKey: "documentos", fieldKey: "inmueble", label: "Inmueble", kind: "relation", relationModuleKey: "proyectos" },
    { moduleKey: "documentos", fieldKey: "tipo", label: "Tipo", kind: "status", required: true, options: [{ value: "nota-simple", label: "Nota simple" }, { value: "escritura", label: "Escritura" }, { value: "ibi", label: "IBI" }, { value: "cee", label: "Certificado eficiencia energética" }, { value: "contrato-encargo", label: "Contrato encargo" }, { value: "contrato-arras", label: "Contrato arras" }, { value: "otro", label: "Otro" }] },
    { moduleKey: "documentos", fieldKey: "fecha", label: "Fecha", kind: "date" },
    { moduleKey: "documentos", fieldKey: "estado", label: "Estado", kind: "status", required: true, options: [{ value: "vigente", label: "Vigente" }, { value: "caducado", label: "Caducado" }, { value: "archivado", label: "Archivado" }] },
  ],
  tableColumns: [
    { moduleKey: "clientes", fieldKey: "nombre", label: "Nombre", isPrimary: true },
    { moduleKey: "clientes", fieldKey: "tipo", label: "Tipo" },
    { moduleKey: "clientes", fieldKey: "telefono", label: "Teléfono" },
    { moduleKey: "clientes", fieldKey: "estado", label: "Estado" },
    { moduleKey: "proyectos", fieldKey: "referencia", label: "Ref.", isPrimary: true },
    { moduleKey: "proyectos", fieldKey: "tipo", label: "Tipo" },
    { moduleKey: "proyectos", fieldKey: "operacion", label: "Operación" },
    { moduleKey: "proyectos", fieldKey: "ciudad", label: "Ciudad" },
    { moduleKey: "proyectos", fieldKey: "precio", label: "Precio" },
    { moduleKey: "proyectos", fieldKey: "estado", label: "Estado" },
    { moduleKey: "presupuestos", fieldKey: "numero", label: "Nº", isPrimary: true },
    { moduleKey: "presupuestos", fieldKey: "cliente", label: "Comprador" },
    { moduleKey: "presupuestos", fieldKey: "importe", label: "Oferta" },
    { moduleKey: "presupuestos", fieldKey: "estado", label: "Estado" },
    { moduleKey: "facturacion", fieldKey: "numero", label: "Nº", isPrimary: true },
    { moduleKey: "facturacion", fieldKey: "cliente", label: "Cliente" },
    { moduleKey: "facturacion", fieldKey: "importe", label: "Importe" },
    ...
    { moduleKey: "crm", fieldKey: "estado", label: "Estado" },
    { moduleKey: "documentos", fieldKey: "nombre", label: "Documento", isPrimary: true },
    { moduleKey: "documentos", fieldKey: "inmueble", label: "Inmueble" },
    { moduleKey: "documentos", fieldKey: "tipo", label: "Tipo" },
    { moduleKey: "documentos", fieldKey: "estado", label: "Estado" },
  ],
  dashboardPriorities: [
    { key: "proyectos", label: "Inmuebles publicados", description: "Cartera activa.", order: 1 },
    { key: "presupuestos", label: "Ofertas en negociación", description: "Operaciones en curso.", order: 2 },
    { key: "facturas", label: "Comisiones pendientes", description: "Por cobrar.", order: 3 },
    { key: "clientes", label: "Personas activas", description: "Propietarios e interesados.", order: 4 },
    { key: "actividad", label: "Actividad reciente", description: "Últimos movimientos.", order: 5 },
  ],
  demoData: [
    { moduleKey: "clientes", records: [
      { nombre: "Juan Martínez (propietario)", tipo: "propietario", telefono: "+34 600 777 001", email: "juan@email.com", preferencias: "", estado: "activo" },
      { nombre: "Ana Torres (compradora)", tipo: "interesado", telefono: "+34 600 777 002", email: "ana@email.com", preferencias: "Piso 3 hab. en Salamanca, max 380k", estado: "activo" },
    ]},
    { moduleKey: "proyectos", records: [
      { referencia: "INM-001", tipo: "piso", operacion: "venta", direccion: "C/ Velázquez 45, 4º B", ciudad: "Madrid", metros: "95", habitaciones: "3", precio: "390000 EUR", propietario: "Juan Martínez (propietario)", estado: "publicado", descripcion: "Piso reformado en zona Salamanca." },
    ]},
    { moduleKey: "presupuestos", records: [{ numero: "OFT-2026-001", cliente: "Ana Torres (compradora)", inmueble: "INM-001", concepto: "Oferta INM-001", importe: "375000 EUR", estado: "negociacion" }] },
    { moduleKey: "facturacion", records: [] },
    { moduleKey: "crm", records: [{ nombre: "Familia López", telefono: "+34 600 777 003", email: "lopez@email.com", buscando: "Casa con jardín en Pozuelo", presupuesto: "550000 EUR", estado: "lead" }] },
    { moduleKey: "documentos", records: [{ nombre: "Nota simple INM-001", inmueble: "INM-001", tipo: "nota-simple", fecha: "2026-04-15", estado: "vigente" }] },
  ],
  landing: {
    headline: "Tu cartera y tus contactos, un solo lugar.",
    subheadline: "ERP para inmobiliarias: cartera de inmuebles, propietarios e interesados, ofertas, documentación y facturación de comisiones.",
    bullets: ["Cartera de inmuebles con tipo, ubicación y precio", "Propietarios e interesados separados por intención", "Ofertas con seguimiento hasta el cierre", "Documentación legal asociada al inmueble"],
    cta: "Activa tu inmobiliaria online",
  },
  assistantCopy: {
    welcome: "Te ayudo con la cartera, ofertas en negociación, comisiones por cobrar y captación de la inmobiliaria.",
    suggestion: "¿Qué inmuebles llevan más de 60 días publicados?",
  },
};

/**
 * Vertical asesoría / consultoría (H5-VERT-05). Color #57534e.
 */
const ASESORIA_PACK: SectorPackDefinition = {
  key: "asesoria",
  label: "Asesoría / Consultoría",
  sector: "servicios-profesionales",
  businessType: "asesoria",
  description: "ERP para asesorías y consultoras: clientes con cuotas mensuales, encargos puntuales, plazos AEAT/Seguridad Social, facturación recurrente.",
  branding: { displayName: "Prontara Asesoría", shortName: "PA", accentColor: "#57534e", logoHint: "consultoría, profesional, B2B", tone: "sectorial" },
  labels: { clientes: "Clientes", crm: "Captación", proyectos: "Encargos", presupuestos: "Presupuestos", facturacion: "Facturas", documentos: "Documentación", ajustes: "Ajustes", asistente: "Asistente" },
  renameMap: { proyecto: "encargo", proyectos: "encargos" },
  modules: [
    { moduleKey: "clientes", enabled: true, label: "Clientes", navigationLabel: "Clientes", emptyState: "Sin clientes." },
    { moduleKey: "crm", enabled: true, label: "Captación", navigationLabel: "Captación", emptyState: "Sin leads." },
    { moduleKey: "proyectos", enabled: true, label: "Encargos", navigationLabel: "Encargos", emptyState: "Sin encargos en curso." },
    { moduleKey: "presupuestos", enabled: true, label: "Presupuestos", navigationLabel: "Presupuestos", emptyState: "Sin presupuestos." },
    { moduleKey: "facturacion", enabled: true, label: "Facturas", navigationLabel: "Facturas", emptyState: "Sin facturas." },
    { moduleKey: "documentos", enabled: true, label: "Documentación", navigationLabel: "Documentos", emptyState: "Sin documentos." },
  ...
  entities: [
    ...
    { key: "encargo", label: "Encargo", description: "Trabajo concreto contratado.", moduleKey: "proyectos", primaryFields: ["nombre", "cliente", "estado"], relatedTo: ["cliente", "factura"] },
  ],
  fields: [
    { moduleKey: "clientes", fieldKey: "nombre", label: "Cliente", kind: "text", required: true },
    { moduleKey: "clientes", fieldKey: "cif", label: "CIF / NIF", kind: "text" },
    { moduleKey: "clientes", fieldKey: "telefono", label: "Teléfono", kind: "tel" },
    { moduleKey: "clientes", fieldKey: "email", label: "Email", kind: "email" },
    ...
    { moduleKey: "proyectos", fieldKey: "cliente", label: "Cliente", kind: "relation", required: true, relationModuleKey: "clientes" },
    { moduleKey: "proyectos", fieldKey: "tipo", label: "Tipo", kind: "status", required: true, options: [{ value: "fiscal", label: "Fiscal" }, { value: "laboral", label: "Laboral" }, { value: "contable", label: "Contable" }, { value: "mercantil", label: "Mercantil" }, { value: "consultoria", label: "Consultoría" }, { value: "otro", label: "Otro" }] },
    { moduleKey: "proyectos", fieldKey: "responsable", label: "Responsable", kind: "text" },
    { moduleKey: "proyectos", fieldKey: "fechaEntrega", label: "Plazo entrega", kind: "date" },
    { moduleKey: "proyectos", fieldKey: "estado", label: "Estado", kind: "status", required: true, options: [{ value: "pendiente", label: "Pendiente" }, { value: "en_curso", label: "En curso" }, { value: "esperando_cliente", label: "Esperando cliente" }, { value: "completado", label: "Completado" }, { value: "cancelado", label: "Cancelado" }] },
    { moduleKey: "proyectos", fieldKey: "notas", label: "Notas", kind: "textarea" },
    { moduleKey: "presupuestos", fieldKey: "numero", label: "Nº", kind: "text", required: true },
    { moduleKey: "presupuestos", fieldKey: "cliente", label: "Cliente", kind: "relation", required: true, relationModuleKey: "clientes" },
    { moduleKey: "presupuestos", fieldKey: "concepto", label: "Concepto", kind: "textarea", required: true },
    { moduleKey: "presupuestos", fieldKey: "importe", label: "Importe", kind: "money", required: true },
    { moduleKey: "presupuestos", fieldKey: "estado", label: "Estado", kind: "status", required: true, options: [{ value: "borrador", label: "Borrador" }, { value: "enviado", label: "Enviado" }, { value: "aceptado", label: "Aceptado" }, { value: "rechazado", label: "Rechazado" }] },
    { moduleKey: "facturacion", fieldKey: "numero", label: "Nº factura", kind: "text", required: true, placeholder: "FAC-ASE-2026-001" },
    { moduleKey: "facturacion", fieldKey: "cliente", label: "Cliente", kind: "text", required: true },
    { moduleKey: "facturacion", fieldKey: "concepto", label: "Concepto", kind: "text" },
    { moduleKey: "facturacion", fieldKey: "importe", label: "Importe", kind: "money", required: true },
    { moduleKey: "facturacion", fieldKey: "fechaEmision", label: "Fecha emisión", kind: "date" },
    ...
    { moduleKey: "crm", fieldKey: "telefono", label: "Teléfono", kind: "tel" },
    { moduleKey: "crm", fieldKey: "email", label: "Email", kind: "email" },
    { moduleKey: "crm", fieldKey: "necesidad", label: "Necesidad", kind: "textarea" },
    { moduleKey: "crm", fieldKey: "estado", label: "Estado", kind: "status", required: true, options: [{ value: "lead", label: "Lead" }, { value: "presupuestado", label: "Presupuestado" }, { value: "cliente", label: "Cliente" }, { value: "perdido", label: "Perdido" }] },
    { moduleKey: "documentos", fieldKey: "nombre", label: "Documento", kind: "text", required: true },
    { moduleKey: "documentos", fieldKey: "cliente", label: "Cliente", kind: "relation", relationModuleKey: "clientes" },
    { moduleKey: "documentos", fieldKey: "tipo", label: "Tipo", kind: "status", required: true, options: [{ value: "modelo-aeat", label: "Modelo AEAT" }, { value: "nomina", label: "Nómina" }, { value: "tc1-tc2", label: "TC1/TC2" }, { value: "contrato", label: "Contrato laboral" }, { value: "informe", label: "Informe" }, { value: "otro", label: "Otro" }] },
    { moduleKey: "documentos", fieldKey: "fecha", label: "Fecha", kind: "date" },
    { moduleKey: "documentos", fieldKey: "estado", label: "Estado", kind: "status", required: true, options: [{ value: "presentado", label: "Presentado" }, { value: "borrador", label: "Borrador" }, { value: "archivado", label: "Archivado" }] },
  ],
  tableColumns: [
    { moduleKey: "clientes", fieldKey: "nombre", label: "Cliente", isPrimary: true },
    { moduleKey: "clientes", fieldKey: "cif", label: "CIF/NIF" },
    { moduleKey: "clientes", fieldKey: "tipoCuota", label: "Cuota" },
    { moduleKey: "clientes", fieldKey: "importeCuota", label: "Importe" },
    { moduleKey: "clientes", fieldKey: "estado", label: "Estado" },
    { moduleKey: "proyectos", fieldKey: "nombre", label: "Encargo", isPrimary: true },
    { moduleKey: "proyectos", fieldKey: "cliente", label: "Cliente" },
    { moduleKey: "proyectos", fieldKey: "tipo", label: "Tipo" },
    { moduleKey: "proyectos", fieldKey: "fechaEntrega", label: "Plazo" },
    { moduleKey: "proyectos", fieldKey: "estado", label: "Estado" },
    { moduleKey: "presupuestos", fieldKey: "numero", label: "Nº", isPrimary: true },
    { moduleKey: "presupuestos", fieldKey: "cliente", label: "Cliente" },
    { moduleKey: "presupuestos", fieldKey: "importe", label: "Importe" },
  ...
  dashboardPriorities: [
    { key: "proyectos", label: "Encargos abiertos", description: "Trabajos en curso.", order: 1 },
    { key: "proyectos", label: "Plazos próximos", description: "Encargos con entrega próxima.", order: 2 },
    { key: "facturas", label: "Cuotas vencidas", description: "Mensuales sin cobrar.", order: 3 },
    { key: "clientes", label: "Cartera activa", description: "Clientes con cuota.", order: 4 },
    { key: "actividad", label: "Actividad reciente", description: "Últimos movimientos.", order: 5 },
  ],
  demoData: [
    { moduleKey: "clientes", records: [
      { nombre: "Comercial Sur S.L.", cif: "B98765432", telefono: "+34 600 888 001", email: "admin@comercialsur.com", tipoCuota: "pyme", importeCuota: "180 EUR", estado: "activo" },
      { nombre: "Pedro Autónomo Ruiz", cif: "12345678X", telefono: "+34 600 888 002", email: "pedro@email.com", tipoCuota: "autonomo", importeCuota: "65 EUR", estado: "activo" },
    ]},
    { moduleKey: "proyectos", records: [
      { nombre: "Modelo 303 Q1 — Comercial Sur", cliente: "Comercial Sur S.L.", tipo: "fiscal", responsable: "Operador", fechaEntrega: "2026-04-20", estado: "completado", notas: "" },
      { nombre: "Renta 2025 — Pedro", cliente: "Pedro Autónomo Ruiz", tipo: "fiscal", responsable: "Operador", fechaEntrega: "2026-06-30", estado: "pendiente", notas: "Falta documentación de gastos" },
    ]},
    { moduleKey: "presupuestos", records: [{ numero: "PRE-ASE-2026-001", cliente: "Comercial Sur S.L.", concepto: "Asesoría fiscal trimestral", importe: "540 EUR", estado: "aceptado" }] },
    { moduleKey: "facturacion", records: [
      { numero: "FAC-ASE-2026-001", cliente: "Comercial Sur S.L.", concepto: "Cuota abril 2026", importe: "180 EUR", fechaEmision: "2026-04-01", estado: "cobrada" },
      { numero: "FAC-ASE-2026-002", cliente: "Pedro Autónomo Ruiz", concepto: "Cuota abril 2026", importe: "65 EUR", fechaEmision: "2026-04-01", estado: "vencida" },
    ]},
    { moduleKey: "crm", records: [{ nombre: "Nuevo Bar S.L. (alta autónomo)", telefono: "+34 600 888 003", email: "info@nuevobar.com", necesidad: "Alta como SL + asesoría fiscal mensual", estado: "lead" }] },
    { moduleKey: "documentos", records: [{ nombre: "Modelo 303 Q1 Comercial Sur", cliente: "Comercial Sur S.L.", tipo: "modelo-aeat", fecha: "2026-04-20", estado: "presentado" }] },
  ],
  landing: {
    headline: "Tu asesoría, sin perder un plazo.",
    subheadline: "ERP para asesorías y consultoras: clientes con cuota mensual, encargos puntuales, plazos AEAT/SS, facturación recurrente.",
    bullets: ["Clientes con tipo de cuota y facturación mensual automática", "Encargos puntuales con plazo y responsable", "Documentación AEAT, nóminas y TC1/TC2", "Captación de nuevos clientes desde lead a cliente fijo"],
    cta: "Activa tu asesoría online",
  },
  assistantCopy: {
    welcome: "Te ayudo con encargos abiertos, plazos próximos, cuotas vencidas y captación de la asesoría.",
    suggestion: "¿Qué encargos vencen este mes?",
  },
};
