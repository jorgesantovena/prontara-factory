...
const moduleData = prontaraConfig.modules.find((m) => m.key === "rrhh");
        ...
        <div style={{ border: "1px solid #ddd", borderRadius: 12, overflow: "hidden", background: "#fff" }}>
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
              <thead>
                <tr>
                  <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "1px solid #ddd", background: "#fafafa" }}>{"Empleado"}</th>
                  <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "1px solid #ddd", background: "#fafafa" }}>{"Area"}</th>
                  <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "1px solid #ddd", background: "#fafafa" }}>{"Estado"}</th>
                  <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "1px solid #ddd", background: "#fafafa" }}>{"Observacion"}</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Claudia"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Delivery"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Activa"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Sin incidencias"}</td>
                </tr>
                <tr>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Diego"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Tecnologia"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Activo"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Guardia semanal"}</td>
                </tr>
                <tr>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Marta"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Calidad"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Activa"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Vacaciones en mayo"}</td>
                </tr>
              </tbody>
            </table>
          </div>
