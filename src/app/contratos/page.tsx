...
const moduleData = prontaraConfig.modules.find((m) => m.key === "contratos");
        ...
        <div style={{ border: "1px solid #ddd", borderRadius: 12, overflow: "hidden", background: "#fff" }}>
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
              <thead>
                <tr>
                  <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "1px solid #ddd", background: "#fafafa" }}>{"Contrato"}</th>
                  <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "1px solid #ddd", background: "#fafafa" }}>{"Cliente"}</th>
                  <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "1px solid #ddd", background: "#fafafa" }}>{"Modalidad"}</th>
                  <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "1px solid #ddd", background: "#fafafa" }}>{"Estado"}</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"CT-001"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Cliente A"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Mantenimiento"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Activo"}</td>
                </tr>
                <tr>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"CT-002"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Cliente B"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Bolsa horas"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Activo"}</td>
                </tr>
                <tr>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"CT-003"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Cliente C"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Proyecto"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Revision"}</td>
                </tr>
              </tbody>
            </table>
          </div>
