...
// TEST 19 — El auto-seed de Niveles + Contratos NO se hace aquí. Escribir
// en el render de un Server Component (layout) no se ejecuta de forma
// fiable en producción. Se hace en el GET de /api/erp/module (niveles/
// contratos) y en /api/erp/prefacturacion, que corren en la petición
// exacta que dispara el usuario. Ver ensureTest19Seed.
