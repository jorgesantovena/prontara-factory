...
const moduleData = prontaraConfig.modules.find((m) => m.key === "finanzas");
        ...
        <div style={{ border: "1px solid #ddd", borderRadius: 12, overflow: "hidden", background: "#fff" }}>
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
              <thead>
                <tr>
                  <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "1px solid #ddd", background: "#fafafa" }}>{"Movimiento"}</th>
                  <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "1px solid #ddd", background: "#fafafa" }}>{"Tipo"}</th>
                  <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "1px solid #ddd", background: "#fafafa" }}>{"Importe"}</th>
                  <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "1px solid #ddd", background: "#fafafa" }}>{"Fecha"}</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Cobro FS-4002"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Ingreso"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"3.200 EUR"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"2026-04-18"}</td>
                </tr>
                <tr>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Licencias cloud"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Gasto"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"640 EUR"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"2026-04-17"}</td>
                </tr>
                <tr>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Proveedor QA"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Gasto"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"420 EUR"}</td>
