    ...
    <TenantShell>
      <div style={{ maxWidth: 1400, margin: "0 auto", fontFamily: "system-ui, -apple-system, sans-serif" }}>
        ...
        <p style={{ color: "#6b7280", fontSize: 13, marginBottom: 16 }}>
          {modelo === "cuota"
            ? "Cuotas. Una línea por contrato del periodo. Mantenimiento (M y E): el Valor del Nivel es anual y se fracciona por el periodo (trimestral ¼, semestral ½, anual 1). Acuerdo específico (A): importe pactado, se factura entero."
