...
const moduleData = prontaraConfig.modules.find((m) => m.key === "planificacion_recursos");
        ...
        <div style={{ border: "1px solid #ddd", borderRadius: 12, overflow: "hidden", background: "#fff" }}>
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
              <thead>
                <tr>
                  <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "1px solid #ddd", background: "#fafafa" }}>{"Recurso"}</th>
                  <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "1px solid #ddd", background: "#fafafa" }}>{"Rol"}</th>
                  <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "1px solid #ddd", background: "#fafafa" }}>{"Carga"}</th>
                  <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "1px solid #ddd", background: "#fafafa" }}>{"Disponibilidad"}</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Claudia"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"PM"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"85pct"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Media"}</td>
                </tr>
                <tr>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Diego"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Fullstack"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"90pct"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Baja"}</td>
                </tr>
                <tr>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Marta"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"QA"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"70pct"}</td>
                    <td style={{ padding: "10px 12px", borderBottom: "1px solid #eee" }}>{"Alta"}</td>
                </tr>
              </tbody>
            </table>
          </div>
